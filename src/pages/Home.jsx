...
const Home = () => {
    const topics = [
        { id: 1, icon: '⚡', title: 'Искусственный интеллект', preview: 'Поделюсь своим опытом длиною в год, перепробовал больш...', date: 'Ср' },
        { id: 2, icon: '#', title: 'General', preview: 'Для получения заказа нужно показать этот QR-код в пункт...', date: 'Вт' },
        { id: 3, icon: '🚮', title: 'Промты', preview: 'Фотография', date: '25.12.25' },
        { id: 4, icon: '🔝', title: 'Тренды и новинки', preview: 'Не знаю, зачем делаю это бесплатно (видимо, моя прос...', date: '19.12.25' },
        { id: 5, icon: '🧮', title: 'Таблички', preview: 'https://ecomunit.ru/wb', date: '18.12.25' },
        { id: 6, icon: '🕰', title: 'Эфиры', preview: '🔥 Пост с зашкаливающим количеством пользы', date: '11.12.25' },
        { id: 7, icon: '🟣', title: 'Wildberries', preview: 'Скриншот 03-12-2025 143207.jpg', date: '03.12.25' },
        { id: 8, icon: '📘', title: 'Книги, статьи', preview: 'ССЫЛКИ ИЗ РОЛИКОВ • loldev();', date: '24.10.25' },
        { id: 9, icon: '🌐', title: 'Блогеры', preview: 'Видео', date: '28.07.25' },
    ];
            ...
            <header style={{ padding: '12px 16px', background: 'var(--bg-color)', position: 'sticky', top: 0, zIndex: 10 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        <button onClick={() => window.history.back()} style={{ padding: 4 }}>
